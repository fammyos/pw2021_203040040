...
<?php 
    ...
    function registrasi($dataa) {
        $conn = koneksi() ;
        $username = strtolower(stripcslashes($dataa["username"])) ;
        $password = mysqli_real_escape_string($conn, $dataa["password"]) ;
        ...
        if(mysqli_fetch_assoc($result)) {
            echo "<script>
                aleert('username sudah digunakan!');
            </script>";
        return false;
    }
