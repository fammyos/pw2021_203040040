...
<html lang="en">
  ...
  <a href="php/login.php">
        <button class="button is-warning mb-5" type="">Sign in to Admin</button>
    </a>
    ...
    <tbody>
        <?php foreach($baju as $bj) : ?>
            <tr>
                ...
                <td class="text-center"><img src="../latihan6a/assets/img/<?= $bj["img"]; ?>" alt=""></td>
                ...
                <td class="text-center"><button class="button dark outline rounded"><a href="../latihan6a/php/detail2.php?id=<?= $bj["id"] ?>">Details</a></button></th>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
