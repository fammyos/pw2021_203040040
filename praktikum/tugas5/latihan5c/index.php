    ...
    <tbody>
        <?php foreach($baju as $bj) : ?>
            <tr>
                ...
                <td class="text-center"><img src="../latihan5c/assets/img/<?= $bj["img"]; ?>" alt=""></td>
                ...
                <td class="text-center"><button class="button dark outline rounded"><a href="../latihan5c/php/detail.php?id=<?= $bj["id"] ?>">Details</a></button></th>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
